      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">temukan keanekaragaman dan kualitas terbaik dengan buah-buahan dan sayuran kami</h1>
            <h2 class="subheading mb-4">Hadirkan keceriaan meja Anda</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">kami menyediakan sayuran dan buah-buahan terbaik untuk kesejahteraan Anda</h1>
            <h2 class="subheading mb-4">Menuju hidup sehat dengan pilihan terbaik</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
